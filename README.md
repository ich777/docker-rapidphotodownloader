...
>**NOTE** Please be sure to NOT change the directory for the source '/media/source' and the destination '/media/destination' folders inside the container, these two folders must specified, otherwise the container will not properly work!
